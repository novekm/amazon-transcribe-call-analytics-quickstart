...
key_tca_output_bucket_name_ENV = os.environ['key_tca_output_bucket_name']
key_tca_app_storage_bucket_name_ENV = os.environ['key_tca_app_storage_bucket_name']
...
def lambda_handler(event, context):
    ...
    ssm_tca_output_bucket_name = ssm_client.get_parameter(Name = key_tca_output_bucket_name_ENV)
    ssm_tca_app_storage_bucket_name = ssm_client.get_parameter(Name = key_tca_app_storage_bucket_name_ENV)
    value_tca_output_bucket_name = ssm_tca_output_bucket_name['Parameter']['Value']
    value_tca_app_storage_bucket_name = ssm_tca_app_storage_bucket_name['Parameter']['Value']
    print(f'Transcribe Input Bucket:{value_tca_output_bucket_name}')
    print(f'Transcribe Input Bucket:{value_tca_app_storage_bucket_name}')
    ...
    return {
        ...
        'body': {
            value_tca_output_bucket_name,
            value_tca_app_storage_bucket_name,
        }
