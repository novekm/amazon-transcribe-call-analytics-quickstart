...
import tcaDiagramBasic from '../../assets/NEW_TCA_Basic_Arch.png';
import tcaDiagramAdvanced from '../../assets/NEW_TCA_Advanced_Arch_Different_S3_icon.png';
              ...
              <div className="custom-home__header-title">
                ...
                <Box fontWeight="light">
                  <span className="custom-home__header-sub-title">
                    Amazon Transcribe Call Analytics is an ML-powered API for
                    generating highly accurate call transcripts and extracting
                    conversation insights to improve customer experience and
                    agent productivity. This project was created to demonstrate
                    how you can easily integrate Amazon Transcribe Call
                    Analytics into a web application.
          ...
          <SpaceBetween size="l">
              ...
              <Container>
                <div>
                  <p>
                    ...
                    <br />
                    <br />
                    Amazon TCA Quickstart provides the following out of the box
                    solutions:
                  </p>
                  <li>Detailed Call Analytics</li>
                  <li>Secure Data Storage</li>
                  <li>Authentication, Authorization, and Auditing</li>
                  <li>Amplify Application</li>
                  <li>GraphQL API</li>
                  <li>Custom Language Model Editor</li>
                  <li>Custom Vocabulary Editor</li>
                  <p>
                    Amazon TCA data is ingested through the Amazon TCA landing
                    zone, and can be ingested from any service within or
            ...
            <div>
              ...
              <Container header={<Header>Basic Architecture</Header>}>
                ...
                <div>
                  <p>This is the basic architecture for Amazon TCA.</p>
                </div>
              </Container>
              <Container header={<Header>Detailed Architecture</Header>}>
                <div>
                  <img
                    src={tcaDiagramAdvanced}
                    alt=""
                    style={{ maxWidth: '100%', paddingRight: '2em' }}
                  />
                </div>
                <div>
                  <p>This is the detailed architecture for Amazon TCA.</p>
                </div>
              </Container>
            </div>
          </SpaceBetween>
...
export const ToolsContent = () => (
  ...
  >
    <p>
      This app is uses to create and manage your contact center call metrics
      using
      <a
        target="_blank"
        rel="noopener noreferrer"
      ...
      . Visit the <a href="/setup-guide"> setup guide</a> for information on how
      to get started.
    </p>
  </HelpPanel>
);
